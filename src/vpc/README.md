...
- [mcp.vpc.backup.json](configs/mcp.vpc.backup.json) - Tools commonly used when working with backups for VPC resources
- [mcp.vpc.baremetal.json](configs/mcp.vpc.baremetal.json) - Tools commonly used when working with bare metal servers
- [mcp.vpc.cluster.json](configs/mcp.vpc.cluster.json) - Tools commonly used when working with VPC Cluster groups
- [mcp.vpc.instance.json](configs/mcp.vpc.instance.json) - Tools commonly used when working with Virtual Server Instances
- [mcp.vpc.lb.json](configs/mcp.vpc.lb.json) - Tools commonly used when working with Virtual Server load balancers
- [mcp.vpc.network.json](configs/mcp.vpc.network.json) - Tools commonly used when working with Virtual Server network resources
- [mcp.vpc.sec.json](configs/mcp.vpc.sec.json) - Tools commonly used when securing Virtual Private Cloud resources
- [mcp.vpc.volume.json](configs/mcp.vpc.volume.json) - Tools commonly used when working with Virtual Server storage volumes
